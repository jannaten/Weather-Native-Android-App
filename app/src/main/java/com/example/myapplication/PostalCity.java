...
public class PostalCity extends AppCompatActivity {
    private Button goBack;
    String postalCode, country;
    EditText PostalEditText, CountryEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_postal_city);
    ...
    public void getWeather( View v ){
        ...
        String url = "https://api.openweathermap.org/data/2.5/weather?zip="+postalCode+","+country+"&appid=034e4c1a00d9f959337a5f7b1cccd8eb";
    ...
    private void parseJsonAndUpdateUI(String response) {
        ...
        try {
            ...
            LinearLayout myLayout3 = (LinearLayout) findViewById(R.id.myLayout3);

            if( temperature > 10 ){ // Overweight
                myLayout3.setBackgroundColor(Color.parseColor("#ff0000"));
            }
            else if( temperature > -5 ) { // Normal Weight BMI between 22 and 26
                myLayout3.setBackgroundColor(Color.parseColor("#00ff00"));
            }
            else { // Underweight
                myLayout3.setBackgroundColor(Color.parseColor("#0000ff"));
            }
